...
#dist_sample <- read.table("/Users/thaisvasconcelos/Desktop/WCVP_special_issue/wcvp_names_and_distribution_specia#l_edition_2022/wcvp_distribution.txt", sep="|", header=TRUE, quote = "", fill=TRUE, encoding = "UTF-8")
#names_sample <- read.table("/Users/thaisvasconcelos/Desktop/WCVP_special_issue/wcvp_names_and_distribution_speci#al_edition_2022/wcvp_names.txt", sep="|", header=TRUE, quote = "", fill=TRUE, encoding = "UTF-8")
#-----------------------------
# If labcomputer
# setwd("~/myrtales")
...
# Reading gbif file
gbif_data <- fread("gbif_big_files/0339018-210914110416597.csv") # load the table you downloaded from GBIF
...
#  }
  write.csv(cleaned_points, file="gbif_big_files/preliminary_cleaning1.csv")
  ...
  write.csv(cleaned_points, file="gbif_big_files/preliminary_cleaning2.csv")
  ...
  write.csv(cleaned_points, file="gbif_big_files/preliminary_cleaning3.csv")
